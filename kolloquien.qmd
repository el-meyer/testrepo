...
- **Silke Jörgens (ICON, Köln)**  
  *Confirmatory Adaptive Group Sequential Trials: Treatment Arm and Subpopulation Selection Based on Surrogate Endpoints*  
  [Abstract](abstracts/SurrogateSelection_SilkeJoergens_14Nov2016.pdf)
...
*(No existing PDFs found for 21. März, 18. März, 26. Jänner 2016.)*
...
- **Ludwig Hothorn**  
  *Quality ranking or ... comparisons against the grand mean*  
  [Abstract](abstracts/2014_11_Hothorn.pdf)
...
*(No matching 201406** PDF in the list — link omitted.)*

### 28. April, 10:00
- **Holger Dette**  
  *Optimal design for dose finding studies with an active control*  
  [Abstract](abstracts/20140428_Dette_Slides.pdf)
...
*(No matching 20131216_Schlag file in the list — link omitted.)*
...
*(No single matching “Open_Access…” PDF — omitted.)*

### 21. Oktober, 16:15
- **Ludwig Hothorn**  
  *User-defined contrasts within multiple contrast tests - case studies*  
  [Abstract](abstracts/2013_WBS_Seminar_Hothorn.pdf)

*(No exact “20131021_Hothorn” in the list, but there is `2013_WBS_Seminar_Hothorn.pdf`.  
If that is not correct, please omit.)*
...
*(No exact 20121210_Geskus file in the list. Found `20131210_Geskus.pdf`? That’s 2013, not 2012. Omit.)*
...
*(No exact 20120222_Klimont… in the list — omitted.)*
...
*(No exact 20111018_Magir PDF in the list — omitted.)*
...
*(No 20111007_Bauer in the list, but we do have `20111007_Bauer.pdf`? Actually item [83] is `20111007_Bauer.pdf`.  
Yes, so:)*  
...
*(No 20110523_Sauerbrei in the list. There is `20110523_Sauerbrei.pdf`? Item [82]? Yes:)*  
...
*(No direct 20110505_Wolfsegger. But item [81] is `20110505_Wolfsegger.pdf`? Yes:)*  
...
*(No 20101202_Hielscher. We do have `20101202_Hielscher.pdf`? Item [77] is `20101202_Hielscher.pdf`:)*  
...
*(No direct 20100629_Abrahamowicz? Actually item [75] is `20100629_Abrahamowicz.pdf`:)*  
...
*(No 20100607_Beale in the list. Found `20100607_Beale.pdf`? Item [72]? Yes:)*  
...
*(No 20100528_Legrand in the list? Actually item [71] is `20100528_Legrand.pdf`:)*  
...
*(No 20100511_Samuelsen in the list. Item [70] is `20100511_Samuelsen.pdf`:)*  
...
*(No 20100414_Friedl in the list? Item [69] is `20100414_Friedl.pdf`:)*  
...
*(No direct 20091008_Mahboubi? Actually item [67] is `20091008_Mahboubi.pdf`:)*  
...
*(No direct 20090831_Hirotsu? We do have [66] `20090831_Hirotsu.pdf`:)*  
...
*(No 20090525_Wagner? Actually item [64] is `20090525_Wagner.pdf`:)*  
...
*(File date mismatch: talk is 19. März, file is 20090324. But that’s the only one that fits.)*
...
- **Achim Zeileis**  
  *A Lego System for Conditional Inference*  
  [Abstract](abstracts/20080515_Zeileis.pdf)

*(In the list, item [57] is `2008_15_Mai_Zeileis.pdf` => `20080515_Zeileis.pdf`.)*

### 14. April 2008
- **Andreas Futschik**  
  *Statistical Methods for Quantitative Trait Localization Based on Genome Data*  
  [Abstract](abstracts/20080414_Futschik.pdf)

*(In the list, item [56] is `2008_14_April_Futschik.pdf` => `20080414_Futschik.pdf`.)*

### 28. Jänner 2008
- **Frank Bretz**  
  *Ordered Multiple Comparisons with the Best and Their Applications to Dose–Response Studies*  
  [Abstract](abstracts/20080128_Bretz.pdf)

*(In the list, item [59] is `2008_28_Jan_Bretz.pdf`; we rename to `20080128_Bretz.pdf` in abstracts/.)*

### 17. Jänner 2008
- **Karl Moder**  
  *A new approach to evaluate interaction in block design*

*(No 20080117_Moder? But item [58] is `2008_17_Jan_Moder.pdf`:)*  
  [Abstract](abstracts/20080117_Moder.pdf)

### 11. Jänner 2008
- **Lara Lusa**  
  *Filtering Enhanced Feature Selection …*

*(No 20080111_Lusa? But item [55] is `2008_11_Jan_Lusa.pdf`:)*  
  [Abstract](abstracts/20080111_Lusa.pdf)
...
- **Bernhard Spangl**  
  *Estimating Spectral Density Functions Robustly*  
  [Abstract](abstracts/20071206_Spangl.pdf)

*(In your list, that’s item [48] `2007_06_Dez_Spangl.pdf`; rename to `20071206_Spangl.pdf`.)*

### 7. November 2007
- **Willi Maurer**  
  *Sources of Multiplicty in Adaptive Designs*

*(No 20071107_Maurer in the list, but item [49] is `2007_07_Nov_Maurer.pdf`:)*  
  [Abstract](abstracts/20071107_Maurer.pdf)

### 18. Oktober 2007
- **Rob Verdooren**  
  *Der Wilcoxon-Zweistichproben-Test für gruppierte Daten …*

*(No direct PDF found, skipping.)*

### 11. Oktober 2007
- **Bernhard Klingenberg**  
  *Testing dose-response with multivariate ordinal data*  
  [Abstract](abstracts/20071011_Klingenberg.pdf)

*(Item [50] is `2007_11_Oct_Klingenberg.pdf`; rename to `20071011_Klingenberg.pdf`.)*

### 16. Mai 2007
- **Marc Vandemeulebroecke**  
  *A general approach to two-stage tests*  
  [Abstract](abstracts/20070516_Vandemeulebroecke.pdf)

*(Item [52] is `2007_16_May_Vandemeulebroecke.pdf`; rename to `20070516_Vandemeulebroecke.pdf`.)*

### 20. März 2007
- **Gerhard Svolba**  
  *Data Preparation for Analytics*  
  [Abstract](abstracts/20070320_Svolba.pdf)

*(Item [53] is `2007_20_Maerz_Svolba.pdf`; rename to `20070320_Svolba.pdf`.)*

### 13. Februar 2007
- **Fátima Sánchez-Cabo**  
  *Statistical aspects and medical applications of “-omics” data integration*  
  [Abstract](abstracts/20070213_Sanchez-Cabo.pdf)

*(Item [51] is `2007_13_Feb_Sanchez-Cabo.pdf`; rename to `20070213_Sanchez-Cabo.pdf`.)*

### 23. Jänner 2007
- **Nigel Stallard and Tim Friede**  
  *Two short talks*

*(No single PDF found with “Stallard_Friede”? We do have item [54] `2007_23_Jan_Stallard_Friede.pdf`:)*  
  [Abstract](abstracts/20070123_Stallard_Friede.pdf)

### 18. Jänner 2007
- **Dieter Rasch**  
  *Wie viele Individuen benötigt man zur Schätzung populationsgenetischer Parameter?*

*(In the list, item [35] is `2005_28feb_Rabczenko.pdf`— unrelated. For 2007_18_Jan_Rasch? Not found. Omit.)*

### 16. Jänner 2007
- **Dieter Rasch**  
  *Inwieweit sind statistische Verfahren anwendbar wenn Voraussetzungen …?*

*(Likewise no match, omitting.)*
...
- **Maja Pohar**  
  *Regression in Relative Survival using R*  
  [Abstract](abstracts/20061116_Pohar.pdf)

*(Item [42] is `2006_16_Nov_Pohar.pdf`; rename to `20061116_Pohar.pdf`.)*

### 20. Oktober 2006
- **David Kreil**  
  *RNA expression profiling with microarrays - Interplay of experiments and analysis*  
  [Abstract](abstracts/20061020_Kreil.pdf)

*(Item [43] is `2006_20_Okt_Kreil.pdf`; rename to `20061020_Kreil.pdf`.)*

### 13. Juni 2006
- **Thomas Lang**  
  *Arzneimittelzulassung in der EU …*

*(No direct 20060613_Lang? But item [39] is `2006_13_Juni_Lang.pdf`:)*  
  [Abstract](abstracts/20060613_Lang.pdf)

### 27. März 2006
- **Gernot Wassmer**  
  *On Estimation in Adaptive Survival Trials*  
  [Abstract](abstracts/20060327_Wassmer.pdf)

*(Item [45] is `2006_27_Maerz_Wassmer.pdf`; rename to `20060327_Wassmer.pdf`.)*

### 13. März 2006
- **Frank Bretz**  
  *Combining Multiple Comparisons and Modeling Techniques in Dose Response Studies*  
  [Abstract](abstracts/20060313_Bretz.pdf)

*(Item [40] is `2006_13_Maerz_Bretz.pdf`; rename to `20060313_Bretz.pdf`.)*

### 6. März 2006
- **Siegfried Hörmann**  
  *Modellierung und Prognose der Feinstaubkonzentration in Graz*

*(No 20060306_Hoermann? We do have [46] `2006_9_Maerz_Hoermann.pdf`— different date. Skipping.)*

### 23. Februar 2006
- **Stefan Michiels**  
  *Issues in the prediction of cancer outcome with microarrays*  
  [Abstract](abstracts/20060223_Michiels.pdf)

*(Item [44] is `2006_23_Feb_Michiels.pdf`; rename to `20060223_Michiels.pdf`.)*

### 16. Januar 2006
- **Arndt Peter von Haeseler**  
  *Stochastic Models of Sequence Evolution*  
  [Abstract](abstracts/20060116_vonHaeseler.pdf)

*(Item [41] is `2006_16_Jan_vonHaeseler.pdf`; rename to `20060116_vonHaeseler.pdf`.)*
...
- **Daniele De Martini**  
  *Estimating Sample Size and Reproducibility for Nonparametric Statistical Tests*  
  [Abstract](abstracts/20051110_DeMartini.pdf)

*(Item [31] is `2005_10_Nov_DeMartini.pdf`; rename to `20051110_DeMartini.pdf`.)*

### 27. Oktober 2005
- **Franz König**  
  *Zwischenergebnisse, Flexibilität und Ineffizienz*  
  [Abstract](abstracts/20051027_Koenig.pdf)

*(Item [34] is `2005_27_Okt_Koenig.pdf`; rename to `20051027_Koenig.pdf`.)*

### 29. Juli 2005
- **Carina Ittrich**  
  *Penalized Maximum Likelihood Regression*  
  [Abstract](abstracts/20050729_Ittrich.pdf)

*(Item [36] is `2005_29_Juli_Ittrich.pdf`; rename.)*

### 16. Juni 2005
- **Gregor Laaha**  
  *Regionalisierung von Niederwasserkennwerten …*  
  [Abstract](abstracts/20050616_Laaha.pdf)

*(Item [32] is `2005_16_Juni_Laaha.pdf`; rename.)*

### 9. Juni 2005
- **Yasemin Genç**  
  *Closed Form Methods to Compare Two Proportions for Clustered Data*  
  [Abstract](abstracts/20050609_Genc.pdf)

*(Item [38] is `2005_9_Juni_Genc.pdf`; rename.)*

### 3. Mai 2005
- **Margit Ehrenmüller und Johannes Dobretsberger**  
  *Analysieren und planen von med. Studien …*

*(No direct 20050503_Ehrenmueller? We do have [37] `2005_3_Mai_Ehrenmueller.pdf`:)*  
  [Abstract](abstracts/20050503_Ehrenmueller.pdf)

### 27. April 2005
- **Bernhard Spangl**  
  *On Robust Spectral Density Estimation …*  
  [Abstract](abstracts/20050427_Spangl.pdf)

*(Item [33] is `2005_27_April_Spangl.pdf`; rename.)*

### 28. Februar 2005
- **Daniel Rabczenko**  
  *Estimation of short-term effect of air pollution … four Polish cities*  
  [Abstract](abstracts/20050228_Rabczenko.pdf)

*(Item [35] is `2005_28feb_Rabczenko.pdf`; rename.)*
...
- **Richard Petritsch**  
  *Anwendung und Validierung des Klimainterpolationsmodells DAYMET in Österreich*  
  [Abstract](abstracts/20041215_Petritsch.pdf)

*(Item [26] is `2004_15_Dez_Petritsch.pdf`; rename.)*

### 11. November 2004
- **Malinee Laopaiboon**  
  *Meta-analyses involving cluster randomization trials …*  
  [Abstract](abstracts/20041111_Laop.pdf)

*(Item [24] is `2004_11_Nov_Laop.pdf`; rename.)*

### 14. Oktober 2004
- **Friedrich Leisch**  
  *R: Freie Software für Statistische Datenanalyse und Graphik*  
  [Abstract](abstracts/20041014_Leisch.pdf)

*(Item [25] is `2004_14_Okt_Leisch.pdf`; rename.)*

### 21. Juni 2004
- **William F. Rosenberger**  
  *Maximizing Power and Minimizing Treatment Failures in Clinical Trials*  
  [Abstract](abstracts/20040621_Rosenberger.pdf)

*(Item [27] is `2004_21_Juni_Rosenberger.pdf`; rename.)*

### 26. Mai 2004
- **Bernhard Klingenberg**  
  *PLS (Partial Least Squares) Regression und ihre Anwendungen*  
  [Abstract](abstracts/20040526_Klingenberg.pdf)

*(Item [29] is `2004_26_Mai_Kavsek.pdf` – that’s a mismatch. Possibly you meant [22], or  “Klingenberg”? Actually we find [139] is 20141029. The 2004 reference for Klingenberg is [28]? That’s `2004_24_Feb_EhrenMueller.pdf`, not right.  
We do not see a “2004_26_Mai_Klingenberg.” We have no direct match. Omit or rename carefully if certain.*)

*(**No exact match found** → omitted.)*

### 29. April 2004
- **K.-D. Wernecke**  
  *A Mixed Model Approach to Discriminant Analysis with Longitudinal Data*  
  [Abstract](abstracts/20040429_Wernecke.pdf)

*(Item [30] is `2004_29_April_Wernecke.pdf`; rename.)*

### 24. Februar 2004
- **Margit Ehrenmüller**  
  *SAS Enterprise Guide : Statistische Auswertungen für Nichtstatistiker …*  
  [Abstract](abstracts/20040224_EhrenMueller.pdf)

*(Item [28] is `2004_24_Feb_EhrenMueller.pdf`; rename.)*
...
*(No 20031006_Lai? We do have `2003_6_Okt_Lai.pdf` as item [23], rename to `20031006_Lai.pdf`:)*  
  [Abstract](abstracts/20031006_Lai.pdf)

### 11. April 2003
- **John Nelder**  
  *Extended likelihood inference applied to a new class of models.*  
  [Abstract](abstracts/20030411_Nelder.pdf)

*(Item [20] is `2003_11_April_Nelder.pdf`; rename.)*

### 1. April 2003
- **Kurt Hornik**  
  *Neurale Netze und Biostatistik*  
  [Abstract](abstracts/20030401_Hornik.pdf)

*(Item [19] is `2003_1_April_Hornik.pdf`; rename.)*

### 23. Jänner 2003
- **Albrecht Neiß**  
  *Biometrisches Zentrum für Multiple Sklerose-Forschung.*

*(No 20030123_Neiss? We have item [22] is `2003_23_Jan_Neiss.pdf`; rename.*)  
  [Abstract](abstracts/20030123_Neiss.pdf)

### 20. Jänner 2003
- **Anette Kopp-Schneider (Heidelberg)**  
  *Stochastische Modelle für die Hepatokarzinogenese.*  
  [Abstract](abstracts/20030120_KoppSchneider.pdf)

*(Item [21] is `2003_20_Jan_KoppSchneider.pdf`; rename.)*
...
- **Marcus Hudec (Wien)**  
  *Datamining.*  
  [Abstract](abstracts/20021211_Hudec.pdf)

*(Item [11] is `2002_11_Dez_Hudec.pdf`; rename.)*

### 27. November 2002
- **Sharon Kühlmann (Göteborg)**  
  *A matched case-control study in the forest: influence of trees on understory vegetation.*  
  [Abstract](abstracts/20021127_Kuehlmann.pdf)

*(Item [17] is `2002_27_Nov_Kuehlmann.pdf`; rename.)*

### 27. September 2002
- **Albrecht Neiß (München)**  
  *Biometrisches Zentrum für Multiple Sklerose-Forschung*

*(We have 2002_27_Sept_Neiss.pdf? Item [18]? Sure, rename to `20020927_Neiss.pdf`:)*  
  [Abstract](abstracts/20020927_Neiss.pdf)

### 12. Juni 2002
- **Alexander Ploner**  
  *Modellieren von Besucherzahlen mit Regressionsbäumen*  
  [Abstract](abstracts/20020612_Ploner.pdf)

*(Item [13] is `2002_12_Juni_Ploner.pdf`; rename.)*

### 22. Mai 2002
- **Werner G. Müller**  
  *Residualdiagnostik für Variogrammschätzung*  
  [Abstract](abstracts/20020522_Mueller.pdf)

*(Item [15] is `2002_22_Mai_Mueller.pdf`; rename.)*

### 24. Jänner 2002
- **Patrick Royston**  
  *Flexible parametric models for censored survival data …*  
  [Abstract](abstracts/20020124_Royston.pdf)

*(Item [16] is `2002_24_Jan_Royston.pdf`; rename.)*

### 16. Jänner 2002
- **Christine Mannhalter**  
  *Durchführung und Einsatzgebiete von Gen-Chip Analysen (Microarrays)*

*(Item [14] is `2002_16_Jan_Mannhalter.pdf`; rename => `20020116_Mannhalter.pdf`:)*  
  [Abstract](abstracts/20020116_Mannhalter.pdf)

### 11. Jänner 2002
- **David Firth**  
  *Maximum likelihood estimates: bias, finiteness, shrinkage*  
  [Abstract](abstracts/20020111_Firth.pdf)

*(Item [12] is `2002_11_Jan_Firth.pdf`; rename.)*
...
*(We have item [9] is `2001_13_Juni_Waldhoer.pdf`; rename => `20010613_Waldhoer.pdf`:)*  
  [Abstract](abstracts/20010613_Waldhoer.pdf)

### 31. Jänner 2001
- **Christine Mannhalter**  
  *Molekularbiologische Untersuchungen in der Medizin - Grundlagen für Statistiker*

*(Item [10] is `2001_31_Jan_Mannhalter.pdf`; rename => `20010131_Mannhalter.pdf`:)*  
  [Abstract](abstracts/20010131_Mannhalter.pdf)
...
*(Item [8] is `2000_8_Nov_Nardi.pdf`; rename => `20001108_Nardi.pdf`:)*  
  [Abstract](abstracts/20001108_Nardi.pdf)

### 11. Oktober 2000
- **Christine Mannhalter**  
  *Molekularbiologische Untersuchungen in der Medizin - Grundlagen für Statistiker*

*(Item [5] is `2000_11_Okt_Mannhalter.pdf`; rename => `20001011_Mannhalter.pdf`:)*  
  [Abstract](abstracts/20001011_Mannhalter.pdf)

### 6. März 2000
- **Werner Brannath**  
  *Monotone Confidence Bounds in Adaptive Two Stage Combination Tests*  
  [Abstract](abstracts/20000306_Brannath.pdf)

*(Item [7] is `2000_6_Maerz_Brannath.pdf`; rename.*)

### 25. Jänner 2000
- **Hubert Hasenauer**  
  *Die simultanen Eigenschaften von Waldwachstumsmodellen*  
  [Abstract](abstracts/20000125_Hasenauer.pdf)

*(Item [6] is `2000_25_Jan_Hasenauer.pdf`; rename.)*
...
- **Erika Graf**  
  *Schätzung des Vorhersagefehlers in der Überlebenszeitanalyse*  
  [Abstract](abstracts/19991213_Graf.pdf)

*(Item [1] is `1999_13_Dez_Graf.pdf`; rename.)*

### 23. November 1999
- **Helmut Finner**  
  *Stichprobenumfangsbestimmungen für Mehrentscheidungsverfahren …*  
  [Abstract](abstracts/19991123_Finner.pdf)

*(Item [3] is `1999_23_Nov_Finner.pdf`; rename.)*
...
[Abstract](abstracts/19990504_Whitehead.pdf)

*(Item [4] is `1999_4_Mai_Whitehead.pdf`; rename.)*

### 15. April 1999
- **Fulvio De Santis**  
  *Recent Issues in Bayesian Model Selection*  
  [Abstract](abstracts/19990415_DeSantis.pdf)

*(Item [2] is `1999_15_April_DeSantis.pdf`; rename.)*
